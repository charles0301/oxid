...
class OrderController extends OrderController_parent
{
    ...
    public function novalnetGatewayReturn()
    {
        ...
        if (in_array($sKey, array('6', '33', '34', '49', '50', '69', '78'))) {
            ...
            $_POST['shop_lang']           = !empty($sInputVal3) ? $sInputVal3 : $oConfig->getRequestParameter('shop_lang');
            $_POST['stoken']              = !empty($sInputVal4) ? $sInputVal4 : $oConfig->getRequestParameter('stoken');
        ...
        $oNovalnetUtil->oLang->setBaseLanguage($shopLang);
