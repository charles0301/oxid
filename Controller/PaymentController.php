...
class PaymentController extends PaymentController_parent {
    ...
    public function getGuaranteePaymentStatus($sPaymentId)
    {
        ...
        if (!empty($blGuaranteeActive)) {
            ...
            $dGuaranteeMinAmount = trim($this->getNovalnetConfig('dGuaranteeMinAmount' . $sPaymentId)) ? $dGuaranteeMinAmount : 2000;
            $dGuaranteeMaxAmount = trim($this->getNovalnetConfig('dGuaranteeMaxAmount' . $sPaymentId)) ? $dGuaranteeMaxAmount : 500000;
