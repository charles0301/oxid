...
class Order extends Order_parent
{
    ...
    private function _logNovalnetTransaction($oBasket)
    {
        ...
        if ($this->_oNovalnetSession->getVariable('dNnAffid')) {
            $this->oDb->execute('INSERT INTO novalnet_aff_user_detail ( AFF_ID, CUSTOMER_ID, AFF_ORDER_NO) VALUES ( ?, ?, ?)', [$this->_oNovalnetSession->getVariable('dNnAffid'), $this->_aNovalnetData['customer_no'], $iOrderNo]);
        }
