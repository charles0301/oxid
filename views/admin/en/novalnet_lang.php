...
$aLang = [
    ...
    'NOVALNET_GUARANTEE_MAXIMUM_AMOUNT_TITLE'  => 'Maximum order amount (in minimum unit of currency. E.g. enter 100 which is equal to 1.00)',
    ...
    'NOVALNET_GUARANTEE_CONFIGURATION_DESCRIPTION'   => 'Basic requirements for payment guarantee
                                                         <ul>
                                                             ...
                                                             <li>Minimum amount of order >= 20,00 EUR</li>
                                                             <li>Maximum amount of order <= 5.000,00 EUR</li>
    ...
    'NOVALNET_GUARANTEE_MINIMUM_AMOUNT_DESCRIPTION'  => 'This setting will override the default setting made in the minimum order amount. Note that amount should be in the range of 20,00 EUR - 5.000,00 EUR',
    'NOVALNET_GUARANTEE_MAXIMUM_AMOUNT_DESCRIPTION'  => 'This setting will override the default setting made in the maximum order amount. Note that amount should be greater than minimum order amount, but not more than 5.000,00 EUR',
    ...
    'NOVALNET_INVALID_GUARANTEE_MINIMUM_AMOUNT_ERROR' => 'The minimum amount should be at least 20,00 EUR but not more than 5.000,00 EUR',
    'NOVALNET_INVALID_GUARANTEE_MAXIMUM_AMOUNT_ERROR' => 'The maximum amount should be greater than minimum order amount, but not more than 5.000,00 EUR',
    ...
    'NOVALNET_BARZAHLEN_PAYMENT_STORE'                => '<br><br><b>Store(s) near you</b><br><br>',
    ...
    'NOVALNET_ADMIN_UPDATE_VERSION'                     => '<h2><b>Novalnet Payment Module V11.2.0</b></h2>',
