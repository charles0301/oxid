...
$aLang = [
    ...
    'NOVALNET_ADMIN_CONFIG_MESSAGE' => 'For additional configurations login to <a class="novalnet_config_link" target="_blank" href="https://admin.novalnet.de">Novalnet administration portal</a>.<br/>To login to the Portal you need to have an account at Novalnet. If you don\'t have one yet, please contact <a href="mailto:sales@novalnet.de">sales@novalnet.de</a> / tel. +49 (089) 923068320<br/><br/>To use the PayPal payment method please enter your PayPal API details in <a class="novalnet_config_link" href="https://admin.novalnet.de" target="_blank">Novalnet administration portal</a>',
    ...
    'NOVALNET_PAYMENT_ACTION_DESCRIPTION'                               => 'Select Capture or Authorize to set onhold',
